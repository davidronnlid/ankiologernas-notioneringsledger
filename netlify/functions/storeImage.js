...
try {
  ...
  // Use strong consistency for immediate read-after-write needs
  blobsStore = getStore({ name: 'notion-images', consistency: 'strong' });
} catch (_) {
...
exports.handler = async (event) => {
  ...
  try {
    ...
    if (blobsStore) {
      ...
      // Public URLs are available via getPublicUrl
